...
# Creo il vettore con tutte le età dei cittadini
...
# Rimuovo dalla lista i valori errati
eta_corretta = ages[ages != 999]

# Ora posso controllare il numero più grande delle età
anziano = eta_corretta.max()
print("Età del cittadino più anziano: ", anziano)